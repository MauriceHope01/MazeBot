...
public class TimerClass implements ActionListener {
    ...
    public TimerClass(String nomeStanza,Robot robot,JLabel statoLbl,JLabel passiLbl)
    {
        ...
        this.oggettiColorati.add(new OggettoColore(new Red()));
        this.oggettiColorati.add(new OggettoColore(new Green()));
        this.oggettiColorati.add(new OggettoColore(new Cyan()));
        this.oggettiColorati.add(new OggettoColore(new Yellow()));
