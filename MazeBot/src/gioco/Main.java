...
public class Main  extends JFrame{
    ...
    private final JLabel titoloLbl = new JLabel("MazeBot");
    private final JTextField nomeTxt = new JTextField(20);
    private final JTextField passwordTxt = new JTextField(20);
    private final JButton nuovaBtn = new JButton("New Game");
    private final JButton classificaBtn = new JButton("Leaderboard");
    private final JButton esciBtn = new JButton("Exit");
    ...
    public void generaGrafica()
    {
        ...
        this.setTitle("Progetto Prog III - Maurizio Speranza");
        this.pack();
    ...
    {
        Leaderboard classifica = new Leaderboard();
